...
## 7. Tradução executiva das principais variáveis

Se você precisar explicar o projeto de forma menos técnica, estas traduções funcionam bem:
...
- `flow_dia`
  - captação líquida diária

- `target_flow_pct_t1_t21`
  - fluxo futuro T+1 a T+21 relativo ao tamanho do fundo

- `flow_pct_63d_sum`
  - fluxo acumulado recente de 63 dias

- `ret_5d`
  - retorno recente de 5 dias

- `vol_63d`
  - volatilidade recente de 63 dias

- `log_pl_lag1`
  - porte do fundo

- `log_nr_cotst_lag1`
  - tamanho da base de cotistas
